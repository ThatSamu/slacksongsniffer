...
var SnifferBot = function Constructor(settings) {
    ...
    this.settings.name = this.settings.name || 'songsniffer';
...
SnifferBot.prototype._postToSpotifyList = function (spotifyURL) {
    var spotifyTrackID = spotifyURL.text.split('/')[-1];
    console.log(spotifyTrackID);
    spotifyApi.addTracksToPlaylist('bablou', '2iEsXvdXvd0H9U6prrz3Ko', ["spotify:track:" + spotifyTrackID])
        .then(function(data) {
