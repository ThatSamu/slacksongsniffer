...
SnifferBot.prototype.run = function () {
    ...
    spotifyApi.clientId = this.settings.spotifyClientID;
    spotifyApi.clientSecret = this.settings.spotifyClientSecret;
    spotifyApi.redirectUri = this.settings.spotifyRedirectURI;
